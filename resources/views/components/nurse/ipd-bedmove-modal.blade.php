<div
    ...
    id="bedmoveModal"
    tabindex="-1"
    aria-labelledby="bedmoveModalLabel"
    aria-hidden="true"
        ...
        <div
            ...
            <div
                ...
                <h5 class="text-xl font-medium leading-normal"
                    :class="type_id == moveout ? 'text-red-800 dark:text-red-200' : 'text-blue-800 dark:text-blue-200'"
                    id="newcaseModalLabel" x-text="type_id == moveout ? 'ย้ายไป' : 'ย้ายภายใน Ward'">
                </h5>
                <!--Close button-->
                <button
                    type="button"
            ...
            <div class="relative flex-auto p-4" data-te-modal-body-ref>
                <div class="block max-w-md rounded-lg bg-white p-6 dark:bg-neutral-700">
                    <form>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="relative mb-6" data-te-input-wrapper-init>
                                <input x-model="ipd.hn" type="text"
                                    class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                    id="InputHN" aria-describedby="HelpHN" placeholder="HN" />
                                <label for="InputHN"
                        ...
                        <!--Ward input-->
                        <div class="mb-6" >
                            <x-input.select :label="__('หอผู้ป่วย')" wire:model="ward_id">
                        ...
                        <div x-show="type_id != moveout" class="mb-6" @rooms-update.window="(e) => { rooms = e.detail.rooms }">
                        ...
                        <div x-show="type_id != moveout" class="mb-6 text-left"
