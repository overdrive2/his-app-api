    ...
    <div
                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-pages" class="py-2 space-y-2 hidden">
                            ...
                            <li>
                                <a href="http://localhost:1313/pages/maintenance/"
                            ...
                            <li>
                                <a href="http://localhost:1313/pages/404/"
                            ...
                            <li>
                                <a href="http://localhost:1313/pages/500/"
                    ...
                    <li>
                        ...
                        <ul id="dropdown-playground" class="space-y-2 py-2 hidden ">
                            <li>
                                <a href="http://localhost:1313/playground/stacked/"
                            ...
                            <li>
                                <a href="http://localhost:1313/playground/sidebar/"
        ...
        <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800"
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700"
                ...
                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(184px, 541px);">
