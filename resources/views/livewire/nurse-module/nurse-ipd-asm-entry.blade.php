    ...
    <div class="flex flex-col gap-2 px-4">
        ...
        <div class="grid lg:grid-cols-4 sm:grid-cols-1 gap-2">
            @foreach($group->asm_detail as $key => $item)
                <div>
                    <h5 class="mb-2">{{ $item->display_order }}.  {{ $item->web_label }}</h5>
                    @switch($item->input_type)
                    @case('RADIO')
                        <div class="" wire:loading.class="opacity-75">
                            <!--First radio-->
                            ...
                            <div class="relative" data-te-input-wrapper-init>
                                <input type="text"
                                    ...
                                    id="editingAnInput" aria-describedby="editingAn" placeholder="Other" />
                            </div>
                            @endif
                        </div>
                        @break
